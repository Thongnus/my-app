    ...
    return (
        <AuthLayout>
            <section className="w-full p-6">
                ...
                <Link to="/signup" className="text-purple-600 mb-4 inline-block hover:underline">
                    Người dùng mới? Đăng ký đây
                </Link>
        ...
        <AuthLayout>
            <section className="w-full p-6">
                ...
                <p className="mt-4 text-gray-600 text-sm">
                    Đã có tài khoản? <Link to="/login" className="text-purple-600 hover:underline">Đăng nhập tại đây</Link>
                </p>
            </section>
        </AuthLayout>
    );
